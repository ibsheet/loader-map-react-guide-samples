...
const Menu = () => {
  ...
  // const ibchart = useSelector(state => state.sheet);
  ...
  const list = () => (
    ...
    >
      <List>
        <ListItem>
          <FaMapMarkedAlt size='30' className={styles.titleIcon} />
          <Divider orientation='vertical' variant='middle' flexItem />
          <div className={styles.titleWrapper}>
            <Typography variant='h6' className={styles.listTitle}>{`IBMAP`}</Typography>
          </div>
        </ListItem>
        <Divider />
        {
